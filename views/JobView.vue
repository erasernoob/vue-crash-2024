...
const deleteJob = async () => {
  try {
    ...
    toast.error('Delete the job Faild', error)
  }
}
...
onMounted(async () => {
  try {
   ...
   state.job = response.data
    ...
    console.error('fetch job data failed')
    console.log(jobId)
  } finally {
  ...
  <BackButton />
    ...
    <section v-if="!state.isLoading" class="bg-green-50">
      <div class="container m-auto py-10 px-6">
        <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
          ...
          <aside>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md">
              ...
              <h2 class="text-2xl">{{ state.job.company.description }}</h2>
        ...
        <div v-else class="text-center text-gray-499 py-6">
            <PulseLoader />        
         </div>
